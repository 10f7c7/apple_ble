...
class Player
    : public sdbus::AdaptorInterfaces<
          org::mpris::MediaPlayer2::Player_adaptor, sdbus::Properties_adaptor /*, more adaptor classes if there are more interfaces*/> {
  public:
  ...
  protected:
    ...
    void Pause() override {
        ...
        Properties_adaptor::emitPropertiesChangedSignal(
            sdbus::InterfaceName{Player_adaptor::INTERFACE_NAME},
    ...
    void SetPosition(const sdbus::ObjectPath &TrackId,
                     const int64_t &Position) override {
        std::cout << "setposition" << std::endl;
        m_Position = Position;
        Properties_adaptor::emitPropertiesChangedSignal(
            sdbus::InterfaceName{Player_adaptor::INTERFACE_NAME},
            {sdbus::PropertyName{"Position"}});
    }
