...
class BLEAdvertisement(Advertisement):
    ...
    def __init__(self, bus, index):
        ...
        # self.add_service_uuid('2A50')
        self.add_manufacturer_data(0xffff, [0x00, 0x02, 0x03, 0x02])
        #self.add_service_data('9999', [0x00, 0x01, 0x02, 0x03, 0x04])
        self.add_local_name('10f7c7-linuz')
...
def main(timeout=0):
    ...
    ad_manager.RegisterAdvertisement(ble_advertisement.get_path(), {},
    ...
    ad_manager.UnregisterAdvertisement(ble_advertisement)
    print('Advertisement unregistered')
    dbus.service.Object.remove_from_connection(ble_advertisement)
